    ...
    <div style={{ display: 'flex' }}>
      <section className={styles.transferencias}>
        ...
        <form className={styles.contenedorFormulario}>
          <div className={styles.contenedorDatos}>
            <label
              htmlFor='receptor'
              className={styles.contenedorDescripcionCampo}
            >
              Receptor
            </label>
            <input
              ...
              placeholder='Cuenta, contacto, correo'
            />
          </div>
          <div className={styles.contenedorDatos}>
            <label
          ...
          <input
            type='submit'
            className={styles.contenedorBotonEnviar}
            value='Enviar Dinero'
          />
        </form>
      </section>
      <section className={styles.transferencias}>
        ...
        <form action='#' className={styles.contenedorFormulario}>
          <div className={styles.contenedorDatos}>
            <label htmlFor='date' className={styles.contenedorDescripcionCampo}>
              Desde
            </label>
            <input
              id='date'
